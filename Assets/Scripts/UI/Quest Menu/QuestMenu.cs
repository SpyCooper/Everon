...
public class QuestMenu : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        starterAssetsInputs.toggleQuestMenu += starterAssetsInputs_ToggleQuestMenu;
    ...
    private void starterAssetsInputs_ToggleQuestMenu(object sender, System.EventArgs e)
    {
        ...
        if(!isMenuOpen)
        {
            ...
            starterAssetsInputs.questMenuPressed = false;
        }
